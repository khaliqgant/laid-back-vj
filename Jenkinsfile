pipeline {
    ...
    stage('Build and push docker images') {
      steps {
        script {
          ...
          docker.withRegistry(NGINX_REPO, ECRCRED)
          {
  ...
  environment {
    PROJECT = 'lbv'
    NGINX_REPO = 'http://568063086568.dkr.ecr.eu-west-1.amazonaws.com'
    NODE_REPO = 'http://568063086568.dkr.ecr.eu-west-1.amazonaws.com'
